...
void setLowPowerACCMeasure(acc_conf_freq_t dataRate);

uint8_t readInterrupt(void);

void readAccelerometerData(uint8_t *buffer);

uint8_t readACC_CONF(void);

uint8_t readPWR_CTRL(void);

uint8_t readPWR_CONF(void);

uint8_t readAcc_Range(void);
